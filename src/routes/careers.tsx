...
export const Route = createFileRoute("/careers")({
  head: () => ({
    meta: [
      { title: "Careers & Training — Practical Digital Skills | Webfortix" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "Webfortix Careers & Training — Learn Skills That Pay",
      },
      {
        ...
        <div className="container-x relative pt-16 pb-14 md:pt-24 md:pb-20">
          <div className="max-w-3xl">
            <p className="inline-flex items-center gap-2 text-sm font-medium uppercase tracking-widest text-primary">
              <GraduationCap className="h-4 w-4" /> Careers & Training
            </p>
